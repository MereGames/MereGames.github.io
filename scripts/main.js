...
window.open('https://oauth.vk.com/authorize?client_id=5505562&redirect_uri=http://meregames.ru&display=page&scope=status&response_type=token&v=5.53&state=1');
